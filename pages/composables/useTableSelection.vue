<template>
  <div>
    <h1>Use Table Selection</h1>
    <main>
      <p>
        This is a demo for a composable that helps in table selection, the
        composable can be found in
      </p>
      ...
      <section class="w-full overflow-x-hidden">
        ...
        <!-- //TODO replace with reusable button  -->
        <div class="flex gap-x-3">
          <button @click="clearSelectedRows">Clear Selection</button>
          <button @click="selectAllRows">Select All Rows</button>
          <button @click="deleteLastRow">Delete Last Row</button>
        </div>
